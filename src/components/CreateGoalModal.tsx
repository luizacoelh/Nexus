...
export default function CreateGoalModal() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = await createGoal({ title, description })
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  placeholder="Ex: Dominar Next.js Backend"
              ...
              <div>
                ...
                <textarea 
                  ...
                  placeholder="Detalhes sobre o que você precisa fazer para alcançar esse objetivo..."
              ...
              {error && (
                <p className="text-xs text-red-400 bg-red-500/10 border border-red-500/20 p-2.5 rounded-lg">
                  Ocorreu um erro ao salvar a meta. Tente novamente.
                </p>
              )}
